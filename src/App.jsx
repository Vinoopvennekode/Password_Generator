      ...
      <div className=" h-screen flex justify-center md:items-center py-11 bg-gradient-to-br from-orange-300 to-amber-100">
        ...
        <div className="">
          ...
          <div className="md:flex justify-around ">
            <div>
              <div className=" h-16 sm:w-96 mx-6 mb-1 flex items-center rounded-3xl justify-between border-2 border-gray-500 bg-slate-100">
